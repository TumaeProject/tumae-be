...
app = FastAPI(
    ...
    description="학생과 튜터를 매칭해주는 플랫폼 API - 완전한 검색, 매칭, 인증 기능",
    version="3.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
)
    ...
    return {
        ...
        "endpoints": {
            "auth": {
                "signup": "/auth/signup",
                "login": "/auth/login",
                "tutor_details": "/auth/tutors/details",
                "student_details": "/auth/students/details"
            },
            "matching": {
...
if __name__ == "__main__":
    ...
    print("🚀 코딩 과외 매칭 API 서버 완전판 시작!")
    print("📖 API 문서: http://localhost:8000/docs")
    print("🔐 인증 API: /auth/signup, /auth/login")
    print("🔍 학생 검색: /api/students")
    print("🔍 튜터 검색: /api/tutors")
